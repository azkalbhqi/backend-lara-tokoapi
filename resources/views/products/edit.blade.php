        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('products.update', $product->id) }}" method="POST" class="max-w-2xl">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            @if($product->image)
                                <div class="mt-2 mb-2">
                                    <img src="{{ $product->image }}" alt="{{ $product->name }}" class="h-20 w-20 object-cover rounded-md border shadow-sm">
                                </div>
                            @endif
                            <x-text-input id="image" class="block mt-1 w-full" type="text" name="image" :value="old('image', $product->image)" placeholder="https://example.com/image.jpg" />
